...
off:function(a,b){if(this._events[a]){var c=this._events[a].indexOf(b);-1<c&&this._events[a].splice(c,1)}},_execevent:function(a){if(this._events[a]){var 0="==b||null===b||"auto"===b?f.max(f.abs(this.x-h.left),f.abs(this.y-h.top)):b;this.scrollTo(h.left,h.top,b,k)}},_transitionTime:function(a){if(this.options.useTransition){a=a||0;var" b="0,c=this._events[a].length;if(c)for(;b<c;b++)this._events[a][b].apply(this,[].slice.call(arguments,1))}},scrollBy:function(a,b,c,e){a=this.x+a;b=this.y+b;this.scrollTo(a,b,c||0,e)},scrollTo:function(a,b,c,e){e=e||d.ease.circular;this.isInTransition=this.options.useTransition&&0<c;var" f="this.options.useTransition&&e.style;!c||f?(f&&(this._transitionTimingFunction(e.style)," this._transitiontime(c)),this._translate(a,b)):this._animate(a,b,c,e.fn)},scrolltoelement:function(a,b,c,e,k){if(a="a.nodeType?a:this.scroller.querySelector(a)){var" h="d.offset(a);h.left-=this.wrapperOffset.left;h.top-=this.wrapperOffset.top;!0===c&&(c=f.round(a.offsetWidth/2-this.wrapper.offsetWidth/2));!0===e&&(e=f.round(a.offsetHeight/2-this.wrapper.offsetHeight/2));h.left-=c||0;h.top-=e||0;h.left=0<h.left?0:h.left<this.maxScrollX?this.maxScrollX:h.left;h.top=0<h.top?0:h.top<this.maxScrollY?this.maxScrollY:" h.top;b="void" c="this;t(function(){"0.0001ms"===c.scrollerStyle[b]&&(c.scrollerStyle[b]="0s")})}if(this.indicators)for(var" e="this.indicators.length;e--;)this.indicators[e].transitionTime(a)}}},_transitionTimingFunction:function(a){this.scrollerStyle[d.style.transitionTimingFunction]=" a;if(this.indicators)for(var="" this));d.hastouch&&!this.options.disabletouch&&(a(this.wrapper,"touchstart",this),a(b,"touchmove",this),a(b,"touchcancel",this),a(b,"touchend",this));a(this.scroller,"transitionend",this);a(this.scroller,"webkittransitionend",this);a(this.scroller,"otransitionend",this);a(this.scroller,"mstransitionend",this)},getcomputedposition:function(){var="" a="g.getComputedStyle(this.scroller,null),b;this.options.useTransform?(a=a[d.style.transform].split(")")[0].split("," "),b="+(a[12]||a[4]),a=+(a[13]||a[5])):" (b="+a.left.replace(/[^-\d.]/g,""),a=+a.top.replace(/[^-\d.]/g,""));return{x:b,y:a}},_initIndicators:function(){function" a(a){if(f.indicators)for(var="" this.options.scrollbars,e="[],d,f=this;this.indicators=[];this.options.scrollbars&&(this.options.scrollY&&(d={el:u("v",b,this.options.scrollbars),interactive:b,defaultScrollbars:!0,customStyle:c,resize:this.options.resizeScrollbars,shrink:this.options.shrinkScrollbars," fade:this.options.fadescrollbars,listenx:!1},this.wrapper.appendchild(d.el),e.push(d)),this.options.scrollx&&(d="{el:u("h",b,this.options.scrollbars),interactive:b,defaultScrollbars:!0,customStyle:c,resize:this.options.resizeScrollbars,shrink:this.options.shrinkScrollbars,fade:this.options.fadeScrollbars,listenY:!1},this.wrapper.appendChild(d.el),e.push(d)));this.options.indicators&&(e=e.concat(this.options.indicators));for(b=e.length;b--;)this.indicators.push(new" v(this,e[b]));this.options.fadescrollbars&&="" (this.on("scrollend",function(){a(function(){this.fade()})}),this.on("scrollcancel",function(){a(function(){this.fade()})}),this.on("scrollstart",function(){a(function(){this.fade(1)})}),this.on("beforescrollstart",function(){a(function(){this.fade(1,!0)})}));this.on("refresh",function(){a(function(){this.refresh()})});this.on("destroy",function(){a(function(){this.destroy()});delete="" this.indicators})},_initwheel:function(){d.addevent(this.wrapper,"wheel",this);d.addevent(this.wrapper,"mousewheel",="" this);d.addevent(this.wrapper,"dommousescroll",this);this.on("destroy",function(){cleartimeout(this.wheeltimeout);this.wheeltimeout="null;d.removeEvent(this.wrapper,"wheel",this);d.removeEvent(this.wrapper,"mousewheel",this);d.removeEvent(this.wrapper,"DOMMouseScroll",this)})},_wheel:function(a){if(this.enabled){var" b,c,e,d="this;void" void="" 0},400);if("deltax"in="" a)1="==a.deltaMode?(b=-a.deltaX*this.options.mouseWheelSpeed,a=-a.deltaY*this.options.mouseWheelSpeed):(b=-a.deltaX,a=-a.deltaY);else" if("wheeldeltax"in="" a)b="a.wheelDeltaX/120*this.options.mouseWheelSpeed,a=a.wheelDeltaY/120*this.options.mouseWheelSpeed;else" if("wheeldelta"in="" if("detail"in="" return;b*="this.options.invertWheelDirection;a*=this.options.invertWheelDirection;" this.hasverticalscroll||(b="a,a=0);this.options.snap?(c=this.currentPage.pageX,e=this.currentPage.pageY,0<b?c--:0">b&&c++,0<a?e--:0>a&&e++,this.goToPage(c,e)):(c=this.x+f.round(this.hasHorizontalScroll?b:0),e=this.y+f.round(this.hasVerticalScroll?a:0),this.directionX=0<b?-1:0>b?1:0,this.directionY=0<a?-1:0>a?1:0,0<c?c=0:c<this.maxscrollx&&(c=this.maxscrollx),0<e?e=0:e<this.maxscrolly&&(e=this.maxscrolly),this.scrollto(c,e,0))}},_initsnap:function(){this.currentpage={};"string"==typeof this.options.snap&&="" (this.options.snap="this.scroller.querySelectorAll(this.options.snap));this.on("refresh",function(){var" a="0,b,c=0,e,d,g,n=0,l;e=this.options.snapStepX||this.wrapperWidth;var" m="this.options.snapStepY||this.wrapperHeight;this.pages=[];if(this.wrapperWidth&&this.wrapperHeight&&this.scrollerWidth&&this.scrollerHeight){if(!0===this.options.snap)for(d=f.round(e/2),g=f.round(m/2);n">-this.scrollerWidth;){this.pages[a]=[];for(l=b=0;l>-this.scrollerHeight;)this.pages[a][b]={x:f.max(n,this.maxScrollX),y:f.max(l,
...
b){if(!b||this.visible){clearTimeout(this.fadeTimeout);this.fadeTimeout=null;var c=a?0:300;this.wrapperStyle[d.style.transitionDuration]=(a?250:500)+"ms";this.fadeTimeout=setTimeout(function(a){this.wrapperStyle.opacity=a;this.visible=+a}.bind(this,a?"1":"0"),c)}}};p.utils=d;"undefined"!=typeof module&&module.exports?module.exports=p:"function"==typeof define&&define.amd?define(function(){return p}):g.IScroll=p})(window,document,Math);</this.minboundaryy?("scale"==this.options.shrink&&(this.height=f.max(this.indicatorheight+3*b,8),this.indicatorstyle.height=this.height+"px"),b=this.minboundaryy):b></this.minboundaryx?("scale"==this.options.shrink&&(this.width=f.max(this.indicatorwidth+a,8),this.indicatorstyle.width=this.width+"px"),a=this.minboundaryx):a></c?this.keyacceleration=c=0:c<this.maxscrollx&&(c=this.maxscrollx,this.keyacceleration=0),0<e?this.keyacceleration=e=0:e<this.maxscrolly&&(e=this.maxscrolly,this.keyacceleration=0),this.scrollto(c,e,0),this.keytime=g)}},_animate:function(a,b,c,e){function></e;d++)if(b></this.snapthresholdx&&f.abs(b-this.absstarty)<this.snapthresholdy)return></b;a++){if(0===a||m[a].offsetleft<=m[a-1].offsetleft)c=0,e++;this.pages[c]||(this.pages[c]=[]);n=f.max(-m[a].offsetleft,this.maxscrollx);l=f.max(-m[a].offsettop,this.maxscrolly);d=n-f.round(m[a].offsetwidth></c?c=0:c<this.maxscrollx&&(c=this.maxscrollx),0<e?e=0:e<this.maxscrolly&&(e=this.maxscrolly),this.scrollto(c,e,0))}},_initsnap:function(){this.currentpage={};"string"==typeof></a?-1:0></b?-1:0></a?e--:0></c&&this._events[a].splice(c,1)}},_execevent:function(a){if(this._events[a]){var></e||e<this.maxscrollx||0<k||k<this.maxscrolly)l=></k-this.starttime&&(this.starttime=k,this.startx=this.x,this.starty=this.y)}}},_end:function(a){if(this.enabled&&d.eventtype[a.type]===this.initiated){this.options.preventdefault&&!d.preventdefaultexception(a.target,this.options.preventdefaultexception)&&a.preventdefault();var></e?-1:0></a||a<this.maxscrollx)a=this.options.bounce?this.x+c></k-this.endtime&&10></1></e?(g=d?e-d></d;e++)if(b=a[e]+"ransform",b>